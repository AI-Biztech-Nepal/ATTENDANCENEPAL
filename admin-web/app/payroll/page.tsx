            ...
            {byEmployee.map((row, i) => {
              ...
              return (
                <tr key={row.id} className={`border-b border-slate-100 last:border-0 hover:bg-slate-100 ${i % 2 === 1 ? 'bg-slate-50/60' : ''}`}>
                  ...
                  <td
                    className={`sticky left-16 z-[1] whitespace-nowrap px-3 py-2 font-medium text-ink border-r border-slate-300 shadow-[10px_0_10px_-6px_rgba(15,23,42,0.22)] print:shadow-none ${rowBg}`}
                  >
